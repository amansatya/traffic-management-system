...
import { Car, Truck, Bus, Bike, Circle } from 'lucide-react';
...
interface ApproachLaneProps {
    ...
    onExpand?: () => void;
    expanded?: boolean;
    videoFile: string; // ✅ new prop for video file path
}
...
const ApproachLane = ({
                          ...
                          onExpand,
                          expanded = false,
                          videoFile // ✅ destructure new prop
                      }: ApproachLaneProps) => {
            ...
            <CardContent className="space-y-4">
                ...
                <div className="relative">
                    <VideoPlayer
                        ...
                        videoSrc={videoFile} // ✅ dynamically passed from parent
                    />
                </div>
